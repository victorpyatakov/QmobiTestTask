...
class TestParseHTML(unittest.TestCase):
        def test_get_currancy_list(self):
            ...
            self.assertEqual(self.parser_2.get_currancy_list(),[['data1','data2'],['data3','data4']])

            self.parser_3 = MyHTMLParser()
            self.html_code_3 = '<tr></tr>'
            self.parser_3.feed(self.html_code_3)
            self.assertEqual(self.parser_3.get_currancy_list(),[])

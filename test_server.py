...
class TestServer(unittest.TestCase):  
    ...
    def test_code_response(self):
        urlData_1 = "http://localhost:8080/converter/api?currancy=usd&amount=54400"
        self.assertEqual(self.get_code_response(urlData_1), '200')

        urlData_2 = "http://localhost:8080/converter/Rapi?currancy=usd&amount=54400"
        ...
        urlData_4 = "http://localhost:8080/converter/api?currancy=usd&amount=-54400"
        self.assertEqual(self.get_code_response(urlData_4), '404')

        urlData_5 = "http://localhost:8080/converter/api?currancy=USSR&amount=54400"
        self.assertEqual(self.get_code_response(urlData_4), '404')
    ...
    def test_response_json(self):
        ...
        urlData_2 = "http://localhost:8080/converter/api?Currancy=eur&Amount=8000000"
